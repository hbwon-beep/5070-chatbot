...
- 항목이 여러 개일 경우 줄바꿈으로 구분해서 안내하세요
- 답변 마지막에 "언제든지 말씀해 주세요" 같은 말은 붙이지 마세요
...
- 참여대상(구직자): 취업을 희망하는 50세 이상 경기도민(외국인도 참여 가능, 경기도민 아니어도 참여 가능)
...
- 최신 일정은 공식 홈페이지(www.5070job.com/calendar)에서 확인하세요
...
- AI 체험 부대행사 운영
- 식음료 판매 부스는 별도 운영하지 않습니다(행사장 상황 따라 다를 수 있음)
...
- 이력서 사전접수: 채용공고 페이지(www.5070job.com/457)에서 사전접수가 있는 기업은 클릭해서 이력서를 미리 제출할 수 있습니다. 이력서 양식은 무관합니다
- 현장에서 시간이 허락하는 한 여러 기업 면접을 동시에 보실 수 있습니다
- 참여기업 업종: 제조, 서비스, 유통 등 다양한 분야의 기업이 참여합니다. 구체적인 참여기업과 채용직종은 홈페이지(www.5070job.com/458)에서 확인하세요
